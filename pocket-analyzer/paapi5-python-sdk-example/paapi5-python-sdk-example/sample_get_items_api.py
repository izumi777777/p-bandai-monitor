                ...
                if item_id in response_list:
                    ...
                    if item is not None:
                        ...
                        if (
                            ...
                            and item.offers_v2.listings[0]["Price"]["Money"]["DisplayAmount"] is not None
                        ):
                            print(
                                "Buying Price: ",
                                item.offers_v2.listings[0]["Price"]["Money"]["DisplayAmount"],
                            )
                else:
                    ...
                    if item_id in response_list:
                        ...
                        if item is not None:
                            ...
                            if (
                                ...
                                and len(item.offers_v2.listings) > 0
                                and "Price" in item.offers_v2.listings[0]
                                and item.offers_v2.listings[0]["Price"]["Money"]["DisplayAmount"]
                                is not None
                            ):
                                print(
                                    "Buying Price: ",
